...
void loop() {
    ...
    for(int j=0;j<NUM_STRIPS;j++)
    {
        ...
        for(int i=0;i<NUM_LEDS_PER_STRIP;i++)
        {
           ...
           leds[(i+off)%NUM_LEDS_PER_STRIP+NUM_LEDS_PER_STRIP*j]=CRGB((NUM_LEDS_PER_STRIP-i)*255/NUM_LEDS_PER_STRIP,i*255/NUM_LEDS_PER_STRIP,(((128-i)+255)%255)*255/ledsperstrip);
