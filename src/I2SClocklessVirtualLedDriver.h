...
extern "C"
{
    ...
    void IRAM_ATTR _gdma_default_tx_isr(void *args)
    {
        ...
        if (intr_status & GDMA_LL_EVENT_TX_EOF)
        {
           ...
           /*
            ...
            _I2SClocklessVirtualLedDriverinterruptHandler(tx_chan->user_data);
        }
        /*
    ...
    esp_err_t _gdma_register_tx_event_callbacks(gdma_channel_handle_t _dma_chan, gdma_tx_event_callbacks_t *cbs, void *user_data)
    {
        ...
        */
        ...
        ESP_RETURN_ON_FALSE(esp_ptr_internal(user_data), ESP_ERR_INVALID_ARG, "lEDOS", "user context not in internal RAM");
